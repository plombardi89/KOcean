...
public data class Action(val id: String, val status: ActionStatus, val type: String, val startTime: Instant?,
                              val completionTime: Instant?, val region: String?, val resourceId: String,
                              val resourceType: String) {

  companion object: ModelFactory<Action> {
    override fun fromJson(json: JsonObject): Action {
      return Action(id             = json.getInt("id").toString(),
